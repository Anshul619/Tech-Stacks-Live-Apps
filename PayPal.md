...
| Purpose           | Service                                                       |
|-------------------|---------------------------------------------------------------|
| Data Streaming    | [Apache Kafka](../HLD-System-Designs/4_MessageBrokersEDA/Kafka/Readme.md)        |
| NoSQL InMemory DB | [Aerospike](../HLD-System-Designs/3_Databases/8_Caching-InMemory-Databases/AeroSpike.md) |
| SQL DB            | PostgreSQL                                                    |
